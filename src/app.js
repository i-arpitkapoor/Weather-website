...
// now since we named the html file index now express already finds a match for what need to be served when we go to the root of the site so the following lines of code gets ignored and index.html gets served when we load the root of the site
// app.get('', (req, res) => {
//     res.send('<h1> Weather </h1>')
// })

// app.get('/help', (req, res) => {   // express would automatically get to know that we have sent an object/array and would stringify it automatically
//     res.send([{
//         name: 'arpit',
//     }, {
//         name: 'Kapoor'
